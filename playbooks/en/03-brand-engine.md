# Playbook 03 — Brand Engine (inbound content)
...
Consistent, compounding inbound: ~1 post a week builds visibility over time. Not "writing for writing's sake" — amplifying the positioning and the anchor cases.

## Cadence & mix

One post a week. Rotate three types:
- **Craft (process):** how you solved a specific problem — process, decisions, result.
- **POV (opinion):** your stance on a topic relevant to the positioning.
- **Proof (case):** a fuller anchor case with metrics.

## Output

`output/content-YYYY-MM-DD/<topic>.md` — draft + meta:
```md
# <working title>
**Type:** craft | POV | case
